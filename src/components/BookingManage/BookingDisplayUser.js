...
/*
** Helper to handle delete events 
*/
...
const BookingDisplayUser = ({user_name}) => {
	...
	useEffect(() => {
		...
		.catch((e) => {console.log(e); alert("error"); window.location.href = "/"})
...
export default BookingDisplayUser;